...
from club.patrones.observer.observer import Subject


class PagoService(Subject):
    """
    Servicio para operaciones de pagos y notificaciones
    Implementa Subject del patrón Observer
    """
    ...
    def __init__(self):
        ...
        # Agregar notificador de pagos como observador
    ...
    def registrar_pago(self, socio: Socio, monto: float, metodo: str = "Efectivo") -> Optional[Pago]:
        ...
        Returns:
            Instancia del pago registrado o None si falla
        """
        try:
    ...
    def calcular_total_recaudado(self) -> float:
        ...
        Returns:
            Suma de todos los montos pagados
        """
    ...
    def calcular_total_recaudado_socio(self, dni: int) -> float:
        ...
        Returns:
            Suma de todos los pagos del socio
        """
    ...
    def mostrar_historial_pagos(self, dni: int):
        ...
        socio = socio_service.obtener_socio(dni)
